...
3. **Structure content**: Use appropriate template from [references/templates.md](.claude/commands/references/templates.md)
...
Always use the templates in [references/templates.md](.claude/commands/references/templates.md). Choose based on issue type:
